...
import in.ifarms.com.EquipmentQrCodeSearch.Update;
...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receivedTokenfromRecycler = receivedIntent.getStringExtra("token");
         ...
         receivedValue="CMMS-AngulliaMosque-072021-001";
        ...
        receivedTokenfromRecycler = sharedPref.getString("token", "");
